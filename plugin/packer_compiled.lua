...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    after = { "plenary.nvim", "nvim-autopairs", "nvim-ts-rainbow", "indent-blankline.nvim", "nvim-treesitter", "nvim-web-devicons", "nvim-lastplace", "nvim-hlslens" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'plenary.nvim', 'nvim-ts-rainbow', 'nvim-treesitter', 'nvim-lastplace'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'plenary.nvim', 'nvim-ts-rainbow', 'nvim-treesitter', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]
